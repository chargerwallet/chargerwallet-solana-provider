...
export const ChargerWalletNamespace = 'chargerwallet:';
export class ChargerWalletSolanaStandardWallet {
    get version() {
    ...
    constructor(provider, options) {
        ...
        _ChargerWalletSolanaStandardWallet_connected.set(this, () => {
            ...
            if (address) {
                ...
                if (!account || account.address !== address || !bytesEqual(account.publicKey, publicKey)) {
                    __classPrivateFieldSet(this, _ChargerWalletSolanaStandardWallet_account, new ChargerWalletSolanaWalletAccount({ address, publicKey }), "f");
        ...
        _ChargerWalletSolanaStandardWallet_signAndSendTransaction.set(this, (...inputs) => __awaiter(this, void 0, void 0, function* () {
            ...
            if (inputs.length === 1) {
                ...
                const { signature } = yield __classPrivateFieldGet(this, _ChargerWalletSolanaStandardWallet_provider, "f").signAndSendTransaction(parseToNativeTx(transaction), {
                    preflightCommitment,
                    minContextSlot,
                    maxRetries,
                    skipPreflight,
        ...
        _ChargerWalletSolanaStandardWallet_signTransaction.set(this, (...inputs) => __awaiter(this, void 0, void 0, function* () {
            ...
            if (inputs.length === 1) {
                ...
                if (chain && !isSolanaChain(chain))
                    throw new Error('invalid chain');
                const signedTransaction = yield __classPrivateFieldGet(this, _ChargerWalletSolanaStandardWallet_provider, "f").signTransaction(parseToNativeTx(transaction));
